...
<body>
	<table id="dg"   class="easyui-datagrid"
		url="/projectInformation/front/project_getProjectListByState?cState=4"
		...
		<thead>
			<tr>
				...
				<th field="dsignPerson" width="100">参加人员</th>
				<th field="dsignAddress" width="100">签约地点</th>
				<th field="csignName" width="100">合同名称</th>
...
<div id="search" title="搜索" iconCls="icon-search" modal="true"
	...
	$(function initsearch() {
		...
		function refresh()
		{
			$('#dg').datagrid('load',{ url:'/projectInformation/front/project_getProjectListByState?cState=4' });
		}
	</script>
	<style type="text/css">
#fm {
