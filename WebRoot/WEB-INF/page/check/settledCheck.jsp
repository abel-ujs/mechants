...
<html>
	...
	<body>
		<table id="dg" title="待审核签约项目" class="easyui-datagrid"
			url="/projectInformation/front/project_getProjectListByState?cState=5"
			...
			<thead>
				<tr>
					...
					<th field="chandlePerson" width="100">
						操作人员
					</th>
					<th field="chandleSubstance" width="100">
						办理事项
					</th>
					<th field="cfruit" width="100">
						落户结果
					</th>
...
function find() {
	...
	function refresh() {
		$('#dg').datagrid('load',{ url:'/projectInformation/front/project_getProjectListByState?cState=5' });
	}
</script>
		<style type="text/css">
#fm {
