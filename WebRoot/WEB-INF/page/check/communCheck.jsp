...
<body>
	<table id="dg"   class="easyui-datagrid"
		url="/projectInformation/front/project_getProjectListByState?cState=2"
		...
		<thead>
			<tr>
				...
				<th field="iend" width="100">是否引进</th>
				<th field="cpersonnel" width="100">小组外其他人员</th>
				<th field="cinformation" width="100">结论</th>
				<th field="cplan" width="100">招商计划</th>
				<th field="coperator" width="100">操作员</th>
				<th field="mdate" width="100">研判日期</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
...
<div id="search" title="搜索" iconCls="icon-search" modal="true"
	...
	$(function initsearch() {
		...
		function refresh()
		{
		$('#dg').datagrid('load',{ url:'/projectInformation/front/project_getProjectListByState?cState=2' });
		}
	</script>
	<style type="text/css">
#fm {
