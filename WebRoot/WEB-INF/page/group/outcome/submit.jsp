...
<html>
	...
	function reload(){
		$('#dg').datagrid('load',{url:'/group/outcome/indexSubmit'});
	}
	...
	$.post('/group/outcome/excelSubmit', {fileName:'outcome.xls'}, function(data) {
	...
	function edit(){
		...
		if (row) {
		$.post('/group/outcome/isEdit',{'cProCode':row.cProCode},function(data,status){
		...
		<div id="dlg" buttons="#dlg-buttons">
			<form id="fm" method="post">
				...
				<div align="center">
					...
					<input name="cInvestment" class="easyui-validatebox" missingMessage="该选项为必选项" data-options="required:true,validType:'num'"/>
				</div>
				<div align="center">
					<label>
						主要产品
