...
<html>
	...
	function reload(){
		$('#dg').datagrid('load',{url:'/group/sign/indexSubmit'});
	}
	...
	function edit(){
		...
		if (row) {
		$.post('/group/sign/isEdit',{'cProCode':row.cProCode},function(data,status){
	...
	$.post('/group/ne/excelSubmit', {fileName:'sign.xls'}, function(data) {
