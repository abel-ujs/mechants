package merchants.web.action.privilege;
	...
	public String insert(){
		...
		if(this.privilegeGroup != null && this.privilegeGroup.getName() != null 
			...
			if (privileges != null && privileges.length > 0) {
				...
				ActionContext.getContext().put("urladdress", "/control/privilege/add");
				return "message";
			}
			//添加权限组
			privilegeGroupService.save(privilegeGroup);
			ActionContext.getContext().put("message", "权限组添加成功");
			ActionContext.getContext().put("urladdress", "/control/privilege/list");
			return "message";
		}
	...
	public String update(){
		...
		if(this.privilegeGroup != null && this.privilegeGroup.getName() != null 
			...
			if (privileges != null && privileges.length > 0) {
				...
				ActionContext.getContext().put("message", "请给权限组分配权限");
				ActionContext.getContext().put("urladdress", "/control/privilege/edit");
				return "message";
			}
			//添加权限组
